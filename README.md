...
-*NOTE*: Sometimes when you recompile after updating the repository, Upp does not recompile everything correctly. If you experience crashes, try to run a full rebuild (the red lightning icon).
